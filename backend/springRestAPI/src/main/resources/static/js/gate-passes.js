...
function viewGatePass(gatePassId) {
    window.open(`/gate-pass-standalone?id=${gatePassId}`, '_blank', 'width=900,height=800');
}
...
function printGatePass(gatePassId) {
    const printWindow = window.open(`/gate-pass-standalone?id=${gatePassId}`, '_blank', 'width=900,height=800');
